...
class HardSpelling extends StatefulWidget {
  const HardSpelling({super.key});

  @override
  _HardSpellingState createState() => _HardSpellingState();
}

class _HardSpellingState extends State<HardSpelling> {
  int _currentSlideIndex = 0;
  bool _isNextPressed = false;
  final TextEditingController _textController = TextEditingController();
  final List<Map<String, dynamic>> _questions = List.generate(20, (index) => _generateQuestion());

  static Map<String, dynamic> _generateQuestion() {
    final words = [
      'computer', 'automobile', 'programming', 'university', 'laboratory', 'microscope', 'television', 'refrigerator', 'microwave', 'calculator', 
      'dictionary', 'encyclopedia', 'philosophy', 'psychology', 'architecture', 'engineering', 'mathematics', 'astronomy', 'geography', 'chemistry'
    ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Hard Spelling'),
      ),
      body: Stack(
        children: [
          Column(
