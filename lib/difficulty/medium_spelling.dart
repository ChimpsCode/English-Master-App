...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MediumSpelling(),
    );
  }
}

class MediumSpelling extends StatefulWidget {
  const MediumSpelling({super.key});

  @override
  _MediumSpellingState createState() => _MediumSpellingState();
}

class _MediumSpellingState extends State<MediumSpelling> {
  int _currentSlideIndex = 0;
  bool _isNextPressed = false;
  final TextEditingController _textController = TextEditingController();
  final List<Map<String, dynamic>> _questions = List.generate(15, (index) => _generateQuestion());

  static Map<String, dynamic> _generateQuestion() {
    final words = ['apple', 'banana', 'elephant', 'giraffe', 'monkey', 'tiger', 'zebra', 'orange', 'grape', 'lemon', 'peach', 'cherry', 'mango', 'kiwi', 'plum'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Medium Spelling'),
      ),
      body: Stack(
        children: [
          Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            // Navigate back to the home screen or any other action you want
                        ...
                        ElevatedButton(
                          onPressed: () {
                            // Optionally, you can navigate to the first question again or restart the quiz
